            ...
            <div class="col-lg-12">
                <div class="ttm-page-title-row-inner">
                    <div class="page-title-heading">
                        <h2 class="title">Community Membership</h2>
                    </div>
                    ...
                    <article class="post ttm-blog-single clearfix">
                        <div class="ttm-blog-single-content mb-0">
                            <div class="entry-content">
                                ...
                                <p>This is the type of membership, joining for the purpose of buying SOILA PLC products at discount rate.
                                    <ul class="ttm-list ttm-list-style-icon d-grid ttm-list-icon-color-skincolor">
                                            ...
                                            <li><i class="fa fa-arrow-circle-right"></i><span
                                                    class="ttm-list-li-content">Eligible persons are petty sellers and entrepreneurs</span>
                                            </li>
                                        </ul>
                                </p>
                            </div>
